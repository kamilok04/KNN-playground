    ...
    def driver(self, knn_method):
        ...
        for metric in self.metrics:
            for k in self.k_values:
                model = KNN(self.data_path, k, classes_to_determine=self.target, reduce_dataset=True, knn_method=knn_method, distance_metric=metric)
                ...
                print(f"Method: {knn_method}, Metric: {metric}, k: {k}, Accuracy: {accuracy:.2f}%")
